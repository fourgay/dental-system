...
urlpatterns = [
    ...
    path('user/get-all-doctor/', get_all_doctors, name='get_all_doctors'),
    ...
    path('doctor/Get-result/', Doctor_get_results, name='Doctor_get_results'),  
    # path('doctor/get-booking', get_booking, name='get-booking')
]