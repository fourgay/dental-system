...
from .views import register, login, Update_user, get_user_info, get_user_profile, get_all_doctors, get_services, get_all_users, admin_register, admin_delete, admin_booking
